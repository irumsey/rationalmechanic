...
#	define LUCID_PROFILER_INITIALIZE()			::lucid::core::Profiler::initialize()
#	define LUCID_PROFILER_ATTACH(external)		::lucid::core::Profiler::attach(reinterpret_cast<::lucid::core::Profiler*>(external))
#	define LUCID_PROFILER_SHUTDOWN()			::lucid::core::Profiler::shutdown()
#	define LUCID_PROFILE_BEGIN(name)			::lucid::core::Profiler::beginSample(name)
#	define LUCID_PROFILE_END()					::lucid::core::Profiler::endSample()
#	define LUCID_PROFILE_SCOPE(name)			::lucid::core::Profiler::ScopedSample scopedProfile##__LINE__(name)
#else

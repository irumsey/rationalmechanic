...
namespace orbit {
	...
	typedef math::Vector<scalar_t,    2> vector2_t;
	typedef math::Vector<scalar_t,    3> vector3_t;
	typedef math::Matrix<scalar_t, 3, 3> matrix3x3_t;
	typedef math::AABB<  scalar_t,    3> aabb3_t;
